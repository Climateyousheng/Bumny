...
.panel
   ...
   .gap
     .block 1
     .text "NOTE: the Root Extract Directories will be extended automatically with RUNID subdirectory on your local machine and" L
     .text "with USERID/RUNID subdirecrories on a remote one." L  
