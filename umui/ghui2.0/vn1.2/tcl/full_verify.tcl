...
proc nav_full_verify {} {
    ...
    global env application exp_id job_id
    ...
    wm title .verify "$exp_id$job_id: Progress of full verification"
    ...
    fv_errors "Errors will be output in this window\n" \
	    "$application: $exp_id$job_id: Errors and Warnings"
...
proc call_check {var val type size} {
    #puts "call_check called with $var type $type size $size"
