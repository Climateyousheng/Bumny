...
proc do_match {prefix array matches} {
	...
	if {$filter!="*"} {
		...
		foreach id $matches {
		    # Test each substring - any match will do
...
proc send_experiment_list {args} {
...
#
proc create_new_experiment {owner initial description} {
...
proc make_experiment_operational {old_id user} {
    ...
    set new_id [create_new_experiment $user q "New Operational Experiment"]
...
proc copy_experiment {exp_id1 user initial description} {
    ...
    set exp_id2 [create_new_experiment $user $initial $description]
