...
proc menu_reload {} {
  ...
  global exp_filters job_filters all_lines vis_lines num_lines titles application


  # get experiment list
  set exp_list [OnPrimaryServer send_experiment_list [concat $exp_filters]]
...
proc menu_exp_new {} {
    ...
    set exp_id [OnBothServers create_new_experiment [list $user $exp_initial $descr]]
