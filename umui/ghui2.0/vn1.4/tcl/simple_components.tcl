...
#puts "ENTRY NAME = $variable VALUE = $value"
	...
	lappend history_var($win) $value
#puts "VARS_ON_WIN $variables_on_window($win)"	
#puts "HIST_VAR $history_var($win)"
...
#puts "A $a"
    ...
    lappend variables_on_window($win) $variable
	lappend history_var($win) $a
#puts "VARS_ON_WINDOW vars on window $variables_on_window($win)"	
#puts "HIST_VAR $history_var($win)"
...
#puts "_RB $link($link_var)"
	
    
    lappend variables_on_window($win) $variable
	lappend history_var($win) $link($link_var)
#puts "vars on window $variables_on_window($win)"	
#puts "HIST_VAR $history_var($win)"
