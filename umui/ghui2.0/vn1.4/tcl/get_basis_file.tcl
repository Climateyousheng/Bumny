...
proc job_not_writable {reason} {
    ...
    button .nowrite.ok -text "OK" -command {destroy_window .nowrite}
...
# proc load_variables
#   Called by all functions (eg edit_job) to load variables registers
#   and databases. Any link variables are reset as well.
# Arguments
#   jobFile: Name of a local file containing a job basis database

proc load_variables {jobFile} {
