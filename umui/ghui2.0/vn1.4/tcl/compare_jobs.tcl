...
# ILP
# set a_list $var_list($run_id1,KSTRT)
# puts "a_list $a_list"
...
proc create_comparisons {list_type} {
	...
	foreach variable $var_list($run_id2) {
		...
		# Produce message which will be output at end
		comparison_message $variable {} $val2 0 1
	    }
	}
    }
}
...
# ILP 
# puts "Variable= $variable 1= $val1 2= $val2 act1= $active1 act2= $active2 "
	...
	if {$line_no!=""} {
		...
		if {$table_diff!=""} {
		    ...
		    # Where a table contains two or more differences, all differences are
		    # found on the first part of the loop and on the second part, help_text
		    # is blank. Ignore blank messages.
		    set help_text ""
		}
		set help1 -1
		set help2 -1
